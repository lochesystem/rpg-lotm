...
```mermaid
flowchart LR
  S0["Sessão 0<br/>opcional"] --> S1["Sessão 1<br/>Sussurro na Oficina"]
  S1 --> S2["Sessão 2<br/>Papel Rasgado"]
  S2 --> S3["Sessão 3<br/>Sala do Espelho"]
  S3 --> S4["Sessão 4<br/>Epílogo"]
  S4 -.-> C1["Campanha 1<br/>opcional"]
```
